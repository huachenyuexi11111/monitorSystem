...
from monitor.mfui import Ui_Dialog_2
import cv2 as cv

class MonitorDialog(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.running = True
        self.flag = 0
    ...
    def SwitchPeo(self):
        ...
        self.th2.stop()
        self.close()
        self.monitorpeopleframe = MonitorPDialog()
        self.monitorpeopleframe.show()
